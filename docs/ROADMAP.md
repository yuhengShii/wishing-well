...
- [ ] **主题配色**：定义品牌色系（主色/辅色/中性色），统一应用到所有页面
- [ ] **图标系统**：tabBar + 状态标签 + 操作按钮使用图标（可选用 iconfont）
- [ ] **空状态插画**：无数据时显示友好插画和引导文案
- [ ] **卡片样式**：优化阴影、圆角、间距，提升层次感
- [ ] **状态标签**：用 emoji 或图标区分状态（pending✏️/approved✅/implemented🚀/rejected❌）

### 品牌元素

- [ ] **App Logo**：设计许愿池品牌标识
- [ ] **首页 Banner**：展示品牌 slogan + 统计概览（总愿望数/总投票数）
- [ ] **欢迎引导**：首次使用展示引导页
...
> **阶段一点五：UI/UX 升级** — 待开始（P1）

下一步具体任务：

1. 设计系统：定义颜色、字体、间距、圆角 CSS 变量
2. 视觉升级：配色、图标、空状态插画
3. 品牌元素：App Logo + 首页 Banner
4. 精细打磨：加载状态、错误提示、按钮状态
